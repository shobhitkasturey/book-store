  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12'>
       ...
       <div className='md:w-1/2'>
            ...
            <p className='mb-10 text-lg md:w-5/6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur voluptate error vel autem voluptates quasi pariatur ea consectetur. 
                Voluptate, voluptatem quasi. Recusandae fugiat rem repellendus incidunt 
                placeat maiores in? Qui.</p>
